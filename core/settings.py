...
INSTALLED_APPS = [
    # 1. Bawaan Django WAJIB berada di urutan paling atas
    ...
    # 2. Cloudinary pindah ke sini (Di bawah staticfiles)
    'cloudinary_storage',
    'cloudinary',
    'django.contrib.gis',
...
STORAGES = {
    # Pengaturan untuk Media/Foto Upload (Dialirkan ke Cloudinary)
    "default": {
        "BACKEND": "cloudinary_storage.storage.MediaCloudinaryStorage",
    },
    # Pengaturan untuk File Statis/CSS/Logo (Dialirkan ke WhiteNoise)
    "staticfiles": {
